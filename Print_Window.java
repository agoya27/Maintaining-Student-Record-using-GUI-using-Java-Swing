...
public class Print_Window extends JFrame
{
	...
	public Print_Window(ArrayList <Student> my_array, HashMap<String,Student> my_map)
    {
      super();
    ...
    private void print_the_list()
    {
    	String message = " ";
    	for(int i =0; i<my_array.size();i++)
    	{
             message = message + my_array.get(i);
    	}
    	my_text_box.setText(message);
    }
    private void make_my_gui()
    {
    	setTitle("Print student information");                                        //Setting the title for JFrame window
